...
/***/ "./resources/js/otherScripts/paginacion.js":
/*!*************************************************!*\
  !*** ./resources/js/otherScripts/paginacion.js ***!
  \*************************************************/
/*! no exports provided */
...
function asociarEventos() {
  ...
  function endPage() {
    if (MARGEN > $(document).height() - $(window).scrollTop() - $(window).height()) {
      ...
      axios.get("/books/paginar/".concat(contador)).then(function (response) {
        if (response.data == "") {
...
/***/ 7:
/*!*******************************************************!*\
  !*** multi ./resources/js/otherScripts/paginacion.js ***!
  \*******************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /home/migue/Sites/ibdbProject/resources/js/otherScripts/paginacion.js */"./resources/js/otherScripts/paginacion.js");
